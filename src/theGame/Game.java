...
public class Game extends Canvas implements Runnable{
    ...
    private final Sprites spriteSheet;
    ...
    public Game(){
        ...
        Sprites introImage = new Sprites(intro);
        this.intro = introImage.getSubimage(1, 1, 1000, 563);
    	...
    	//Load  sprites
        this.loader = new BufferedImageLoader();
        BufferedImage sprites = loader.loadImage("/sprite-sheet.png");
...
//////////////////////////////////////////////////////////////////
    ...
    public void creditsScreen(Graphics g) {
    	...
    	if(this.handler.roomCleared() & Objects.equals(this.currentLevel, "/level_boss.png")) {
    		...
    		for(int j = 0; j < height; j++) {
				...
				if(this.currentLevel.equals("/level_1.png")) {
					if (red == 255 && green == 255 && blue == 0) {
						this.handler.addObject(new Bug(i * 32, j * 32, ID.Bug, handler, spriteSheet));
					}
					if (red == 255 && green == 0 && blue == 0) {
						this.handler.addObject(new Bush(i * 32, j * 32, ID.Bush, spriteSheet));
					}
				}

				if(this.currentLevel.equals("/level_2.png")) {
					if(red == 255 && green == 255 && blue == 0) {
						this.handler.addObject(new Crab(i*32, j*32, ID.Crab, handler, spriteSheet));
					}
					if(red == 255 && green == 0 && blue == 0) {
						this.handler.addObject(new Rock(i*32, j*32, ID.Rock, spriteSheet));
					}
				}

				if(this.currentLevel.equals("/level_boss.png")) {
					if(red == 255 && green == 255 && blue == 0) {
